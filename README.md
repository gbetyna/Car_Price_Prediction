...
The project demonstrates the full ML workflow, including exploratory data analysis, preprocessing,
model training and evaluation, model persistence, and deployment via a Streamlit web application.
